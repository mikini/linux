...
extern gid_t from_kgid_isolated(struct user_namespace *to, kgid_t gid);
...
static inline gid_t from_kgid_isolated(struct user_namespace *to, kgid_t kgid)
{
	gid_t gid = from_kgid(to, kgid);
	if (gid == (gid_t)-1)
		gid = overflowgid;
